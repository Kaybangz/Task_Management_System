    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotificationProject", x => new { x.NotificationsId, x.ProjectsId });
                    table.ForeignKey(
                        name: "FK_NotificationProject_Notifications_NotificationsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotificationUserTask", x => new { x.NotificationsId, x.TasksId });
                    table.ForeignKey(
                        name: "FK_NotificationUserTask_Notifications_NotificationsId",
                        column: x => x.NotificationsId,
                        principalTable: "Notifications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_NotificationUserTask_Tasks_TasksId",
                        column: x => x.TasksId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationUserTask_TasksId",
                table: "NotificationUserTask",
                column: "TasksId");
